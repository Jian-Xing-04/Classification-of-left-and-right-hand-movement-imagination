...
# ==================== EPOC 3-type Dataset ====================
EPOC_DATA_DIR = PROJECT_ROOT / "EEG MI-BCI Mouse Cursor Dataset"

# ==================== EDF Dataset (Self-collected) ====================
EDF_DATA_DIR = PROJECT_ROOT / "edf_files"
...
# ==================== EEGNet Model ====================
EEGNET_F1 = 8          # 时序卷积滤波器数量
EEGNET_D = 2           # 深度乘数 (depth multiplier)
EEGNET_F2 = 16         # 可分离卷积滤波器数量 (通常 = F1 * D)
EEGNET_KERNEL1 = 64    # 时序卷积核大小 (时间维度)
